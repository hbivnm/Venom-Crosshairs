...
## Preview image
![Preview image of Venom Crosshairs.](https://i.imgur.com/QC4gQUd.png)
...
3. Close Team Fortress 2 and run `VenomCrosshairs.exe` and customize your weapon-specific crosshair config.
