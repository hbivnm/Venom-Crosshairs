...
namespace VenomCrosshairs
{
    public static class TF2Weapons
    {
        ...
        // Special
        private static readonly string[] tf2SpecialWeapons = { "JACK", "Grappling Hook", "Spellbook" };
        ...
        private static readonly string[] tf2MiscSpecialWeapons = { "Grappling Hook", "Spellbook" };
        ...
        public static string getWeaponScriptFromWeaponName(string weaponName)
        {
            switch (weaponName)
            {
                ...
                case "Grappling Hook":
                    return "tf_weapon_grapplinghook.txt";
                case "Spellbook":
        ...
        public static string getWeaponNameFromWeaponScript(string weaponScript)
        {
            switch (weaponScript)
            {
                ...
                case "tf_weapon_passtime_gun.txt":
                    return "JACK";
                case "tf_weapon_grapplinghook.txt":
